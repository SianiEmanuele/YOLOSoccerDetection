...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default=r'src\models\esrgan\train\dataset\input_dataset', help='Input folder')
    parser.add_argument('--output', type=str, default=r'src\models\esrgan\train\dataset\output_dataset_sub', help='Output folder')
