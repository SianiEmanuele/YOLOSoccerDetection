...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input',
        nargs='+',
        default=[r'src\models\esrgan\train\dataset\input_dataset', r'src\models\esrgan\train\dataset\output_dataset_multiscale'],
        help='Input folder, can be a list')
    parser.add_argument(
        '--root',
        nargs='+',
        default=[r'src\models\esrgan\train\dataset', r'src\models\esrgan\train\dataset'],
        help='Folder root, should have the length as input folders')
    parser.add_argument(
        '--meta_info',
        type=str,
        default=r'src\models\esrgan\train\dataset\meta_info\meta_info_dataset_multiscale.txt',
